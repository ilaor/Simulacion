class HeightMap
{
  ...
  void addRaindropWave(float x, float y, float z) {
    waves.add(new WaveRadial(10, new PVector(x, y, z), 20, 10)); // Parámetros de la onda radial ajustables según necesidad
  }
